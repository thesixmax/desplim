...
The `compact_train` data contains the human-assigned compactness score (`compact`), ranging from 0 (least compact) to 1 (most compact) and 10 geometric features for 547 unique district shapes.
